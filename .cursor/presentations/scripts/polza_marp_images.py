...
def main() -> int:
    ...
    parser.add_argument("-o", "--output", default=".cursor/presentations/assets/generated/placeholder.txt")
    args = parser.parse_args()

    output_path = Path(args.output)
    output_path.parent.mkdir(parents=True, exist_ok=True)
    output_path.write_text(
        "Placeholder output from .cursor/presentations/scripts/polza_marp_images.py\n",
        encoding="utf-8",
    )
    return 0

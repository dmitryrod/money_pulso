...
1. Прочитан [`marketing-context`](../marketing-context/SKILL.md) и **`app/docs/marketing/context.md`** (при необходимости — указатель `.cursor/marketing-context.md`)
...
| product name, brand name, domain, naming, нейминг, название продукта, переименование, слоган и имя | `product-naming` | `branding`, `copy-editing` |

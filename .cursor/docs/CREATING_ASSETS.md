...
**Контекст продукта:** канон текста — [`app/docs/marketing/context.md`](../../app/docs/marketing/context.md); указатель в Cursor — [`.cursor/marketing-context.md`](../marketing-context.md); шаблон секций — [`.cursor/marketing-context.example.md`](../marketing-context.example.md). **Исследования / roadmap / synthesis** — каталог [`app/docs/marketing/research/`](../../app/docs/marketing/research/) (имена и фазы — в [`marketing-research-playbook`](../skills/marketing-research-playbook/SKILL.md)). **Тактические маркетинговые артефакты** по умолчанию — [`app/docs/marketing/artifacts/`](../../app/docs/marketing/artifacts/) (агент `marketing`). Долгие продуктовые тексты **не** хранить в `.cursor/` как единственный источник. Карта upstream → локальных skills: [`MARKETING_SKILLS_UPSTREAM.md`](MARKETING_SKILLS_UPSTREAM.md).
...
- **Про идентичность проекта (marketing):** флаг `--strip-project-identity` — бэкап **указателя** `.cursor/marketing-context.md` и удаление **или** замена из [`.cursor/marketing-context.example.md`](../marketing-context.example.md) вместе с `--replace-with-example`. Канон в `app/docs/marketing/` скрипт **не** трогает. Шаблоны `*.example.md` **никогда** не удаляет.
...
- [`marketing-context`](../skills/marketing-context/SKILL.md) — единый продуктовый маркетинговый контекст (`app/docs/marketing/context.md`, указатель `.cursor/marketing-context.md`)
- [`marketing-router`](../skills/marketing-router/SKILL.md) — маршрутизация запроса к 1–3 leaf marketing skills
- [`product-naming`](../skills/product-naming/SKILL.md) — нейминг продукта/бренда/домена (адаптация практик skills.sh: domain-name-brainstormer, product-name, brand-name-generator)

...
| domain-name-brainstormer (composiohq) + product-name (phuryn) + brand-name-generator (shipshitdev) | — | `product-naming` | домены/TLD workflow, PM-формат кандидата, стратегии + скоринг — см. `references/` |
| product-marketing-context (Corey) | — | `marketing-context` | канон `app/docs/marketing/context.md`, указатель `.cursor/marketing-context.md` |

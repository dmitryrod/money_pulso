...
- **Режим «Тест» — карточка**: горизонтальная компоновка в одну строку (тикер и Score, тело сообщения Telegram, по колонке на каждый фильтр, биржа и время); при нехватке ширины — **горизонтальная прокрутка** всей полосы карточки. Режимы БД и лог-файла — прежняя узкая вертикальная карточка.
